...
class Dictionary : public IDictionary {
   public:
    ...
    void allocate() {
        ...
        for (auto &dirName : fs::directory_iterator{"/Users/tranhainam/Documents/build-CS163-Project-Qt_6_3_0_for_macOS-Debug/data/dicts"}) {
            QString dictName =
    ...
    bool reset() {
        ...
        QDir("/Users/tranhainam/Documents/build-CS163-Project-Qt_6_3_0_for_macOS-Debug/data/dicts/" + dictName).removeRecursively();
        fs::copy("/Users/tranhainam/Documents/build-CS163-Project-Qt_6_3_0_for_macOS-Debug/data/dicts-origin/" + dictNameStdString,
                 "/Users/tranhainam/Documents/build-CS163-Project-Qt_6_3_0_for_macOS-Debug/data/dicts/" + dictNameStdString,
